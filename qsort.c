...
typedef int (*__compar_r_fn_t)(const void *, const void *, void *);

void
_quicksort (void *const pbase, size_t total_elems, size_t size, __compar_r_fn_t cmp, void* arg)
{
...
int __qsort_single(const void* first, const void* second, void* arg) {
    __compar_fn_t cmp = arg;
